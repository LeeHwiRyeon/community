...
<body>
        ...
        <div id="members" class="tab-content">
            ...
            <ul class="member-list">
                ...
                <li class="member-item">
                    <div class="member-info">
                        <h4>스팸유저 (차단됨)</h4>
                        <p>spam@example.com • 가입일: 2024-12-20 • 게시물: 0개</p>
                    </div>
                    <div class="member-actions">
                        <button class="btn btn-small" onclick="unbanMember(3)">차단 해제</button>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div id="activities" class="tab-content">
            ...
            <ul class="member-list">
                ...
                <li class="member-item">
                    <div class="member-info">
                        <h4>👋 가입 - 신규유저</h4>
                        <p>AI 연구소에 새 멤버 가입 • 대기중</p>
                        <p>시간: 2025-01-02 09:15</p>
                    </div>
                    <div class="member-actions">
                        <button class="btn btn-small" onclick="approveActivity(2)">승인</button>
                        <button class="btn btn-ban btn-small" onclick="rejectActivity(2)">거부</button>
                    </div>
                </li>
            </ul>
        </div>
    ...
    async runRealTests() {
        ...
        // 뉴스 관리자 버튼 클릭
        const newsButton = await this.page.$('a[href="/news-manager"]');
        if (newsButton) {
            await newsButton.click();
            await this.page.waitForNavigation();
            await this.takeScreenshot('news-manager-after-click', '뉴스 관리자 버튼 클릭 후');
            console.log('✅ 뉴스 관리자 버튼 클릭 성공');
        }

        // 뉴스 관리자 테스트
        console.log('\n📰 뉴스 관리자 테스트 시작...');
        await this.page.goto(`http://localhost:${this.port}/news-manager`, { waitUntil: 'networkidle0' });
        ...
        // 커뮤니티 관리자 테스트
        console.log('\n👥 커뮤니티 관리자 테스트 시작...');
        await this.page.goto(`http://localhost:${this.port}/community-manager`, { waitUntil: 'networkidle0' });
        ...
        if (newCommunityButton) {
            ...
            console.log('✅ 새 커뮤니티 생성 버튼 클릭 성공');
        }
...
if (require.main === module) {
    const tester = new SimpleNewsCommunityTest();
    tester.runRealTests().catch(console.error);
}

module.exports = SimpleNewsCommunityTest;
